...
def part1():
    inputs = read_file_as_string("../inputs/day_17.txt")
    grid = [list(map(int, row)) for row in inputs.splitlines()]
    seen = set()
    # heat loss, row, col, direction row, direction col, number of moves in a direction
    pq = [(0, 0, 0, 0, 0, 0)]
    while pq:
